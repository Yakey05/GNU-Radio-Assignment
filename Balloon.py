...
class Balloon(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Balloon")
        ...
        self.ival_decimator_0 = filter.ival_decimator(100000, gr.sizeof_short)
        self.gr_digital_rf_digital_rf_source_0 = gr_digital_rf.digital_rf_source(
            'C:\\Users\\grans\\Downloads\\ch0',
            channels=[
                '',
            ],
            start=[
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_short*1, 'C:\\Users\\grans\\Documents\\Baloon\\signal_Tot3.txt', False)
        ...
        self.connect((self.blocks_float_to_short_0, 0), (self.ival_decimator_0, 0))
        ...
        self.connect((self.gr_digital_rf_digital_rf_source_0, 0), (self.blocks_throttle2_0, 0))
        self.connect((self.ival_decimator_0, 0), (self.blocks_file_sink_0, 0))
        self.connect((self.ival_decimator_0, 0), (self.blocks_short_to_float_0, 0))
    ...
    def set_center_freq(self, center_freq):
        ...
        self.qtgui_waterfall_sink_x_0_0.set_frequency_range(self.center_freq, self.BW)
...
def main(top_block_cls=Balloon, options=None):
